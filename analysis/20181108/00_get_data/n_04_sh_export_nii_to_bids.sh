...
fslreorient2std ${strRaw}PROTOCOL_BP_ep3d_bold_func_01_RL_SERIES_018_c32 ${strFunc}func_03
fslreorient2std ${strRaw}PROTOCOL_BP_ep3d_bold_func_02_RL_SERIES_020_c32 ${strFunc}func_04
...
fslreorient2std ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_03_RL_SERIES_030_c32 ${strFunc}func_09
#------------------------------------------------------------------------------
...
fslreorient2std ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_013_c32 ${strAnat}mp2rage_pdw
fslreorient2std ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_014_c32 ${strAnat}mp2rage_pdw_phase
fslreorient2std ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_015_c32 ${strAnat}mp2rage_t1
fslreorient2std ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_016_c32 ${strAnat}mp2rage_uni
#------------------------------------------------------------------------------
