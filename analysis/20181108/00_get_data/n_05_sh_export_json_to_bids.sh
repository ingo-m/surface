...
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_SERIES_008_c32.json ${strFunc}func_01.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_02_RL_SERIES_010_c32.json ${strFunc}func_02.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_func_01_RL_SERIES_018_c32.json ${strFunc}func_03.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_func_02_RL_SERIES_020_c32.json ${strFunc}func_04.json
...
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_03_RL_SERIES_030_c32.json ${strFunc}func_09.json
#------------------------------------------------------------------------------
...
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_013_c32.json ${strAnat}mp2rage_pdw.json
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_014_c32.json ${strAnat}mp2rage_pdw_phase.json
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_015_c32.json ${strAnat}mp2rage_t1.json
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_016_c32.json ${strAnat}mp2rage_uni.json
#------------------------------------------------------------------------------
