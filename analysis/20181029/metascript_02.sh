...
source ${strPathPrnt}05_postprocessing/n_04_sh_fsl_copy_cope_sst.sh
source ${strPathPrnt}05_postprocessing/n_05_sh_fsl_copy_cope_tran.sh
source ${strPathPrnt}05_postprocessing/n_06_sh_fsl_copy_cope_comb.sh
