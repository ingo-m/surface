...
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_pRF_run01_SERIES_008_c32.json ${strFunc}func_01.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_pRF_run02_SERIES_010_c32.json ${strFunc}func_02.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run01_SERIES_012_c32.json ${strFunc}func_03.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run02_SERIES_014_c32.json ${strFunc}func_04.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run03_SERIES_022_c32.json ${strFunc}func_05.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run04_SERIES_024_c32.json ${strFunc}func_06.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run05_SERIES_026_c32.json ${strFunc}func_07.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_run06_SERIES_028_c32.json ${strFunc}func_08.json
cp ${strRaw}PROTOCOL_BP_ep3d_bold_pRF_01_RL_pRF_run03_SERIES_030_c32.json ${strFunc}func_09.json
#------------------------------------------------------------------------------
