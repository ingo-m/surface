...
lstIn_02 = ['EV_func_01_Kanizsa.txt',
            'EV_func_02_Kanizsa.txt',
            'EV_func_03_Kanizsa.txt',
            'EV_func_04_Kanizsa.txt',
            'EV_func_05_Kanizsa.txt',
            'EV_func_06_Kanizsa.txt']
...
# Output file name:
strOutFileName = 'ERA_Kanizsa.nii.gz'
