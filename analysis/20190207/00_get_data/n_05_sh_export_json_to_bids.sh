...
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_013_c32.json ${strAnat}mp2rage_inv1.json
cp ${strRaw}PROTOCOL_mp2rage_0.7_iso_p2_SERIES_014_c32.json ${strAnat}mp2rage_inv1_phase.json
