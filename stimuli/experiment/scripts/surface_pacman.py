...
#
# Mean pixel intensity of random texture background (used in Pac-Man study) is,
# in RGB values (range 0 to 255): 37
...
# Texture (if True, random pattern background is displayed):
if dicExpInfo['Texture'] == 'Yes':
    lgcTxtr = True
else:
    lgcTxtr = False
